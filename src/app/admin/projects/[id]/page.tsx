...
export default function ProjectDetailPage() {
  ...
  const tech = parseList(form.technologies);
  const features = parseList(form.key_features);
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_0.92fr] gap-8 xl:gap-10 items-start">
        ...
        >
          ...
          >
            ...
            {editMode ? (
              <textarea
                value={Array.isArray(form.key_features) ? form.key_features.join(', ') : form.key_features || ''}
                onChange={(e) =>
                  setForm({
                    ...form,
