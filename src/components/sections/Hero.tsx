...
const skills = ["Python", "Java", "Claude","Antigravity",];
type HeroProps = {
  showApp: boolean;
};
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          zIndex: 40,
          pointerEvents: showApp && isInView ? "auto" : "none",
        }}
      >
        {showApp && isInView && <App />}
      </div>
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Computer Science Student", "Aspiring CyberSecurity Engineer", "Tech Enthusiast!"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
          Building today with the mindset to shape tomorrow.
          </p>
        </motion.div>
