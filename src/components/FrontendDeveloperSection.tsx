...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Building secure, robust software applications while engineering interactive AI-assisted web platforms.
        </motion.p>
        ...
        >
          {["Java & Python", "Cyber Security", "Linux Systems", "AI Web Dev"].map((tech) => (
            <div
              key={tech}
              className="
